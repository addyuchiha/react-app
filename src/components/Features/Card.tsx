  ...
  return (
    <div className="bg-gradient-to-b from-accent to-indigo-300 p-8 rounded-3xl space-y-2 w-full">
      ...
      <span className="text-white">
        ...
        Porro blanditiis totam quasi.
      </span>
      <button className="bg-bgLight rounded-xl p-2 flex justify-center items-center space-x-2 w-full hover:brightness-90 transition-all">
        <p>Open Tool</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
